...
module.exports = class Game {
  constructor (room, deck, roomsList) {
    ...
    // Keep a pointer to the servers' list of rooms
  ...
  checkGameOver () {
    ...
    this.roomsList[this.name].playing = false
    this.roomsList[this.name].game = null
