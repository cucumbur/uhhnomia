...
// Audio clips
var soundDingGood = new Audio('assets/sounds/ding-good.mp3')
// var soundDingBad = new Audio('assets/sounds/ding-bad.mp3')
var soundMatchup = new Audio('assets/sounds/matchup.mp3')
